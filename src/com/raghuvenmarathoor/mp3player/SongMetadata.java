    ...
    public SongMetadata(String mp3File){
        try {
            ...
            if(mP3File.hasID3v2Tag()){
                ...
                artist = artist + id3v2.getFirst(FieldKey.ARTIST);
                title = title + id3v2.getFirst(FieldKey.TITLE);
                 artist = artist + id3v2.getFirst(FieldKey.ARTIST);
                album = album + id3v2.getFirst(FieldKey.ALBUM);
                genre = genre + id3v2.getFirst(FieldKey.GENRE);
                year = year + id3v2.getFirst(FieldKey.YEAR);
            }
